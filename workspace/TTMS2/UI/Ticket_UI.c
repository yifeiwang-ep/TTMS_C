...
void Ticket_UI_Print(int ID){
	...
	play_t     pld;
   	...
   	switch(pld.type){
						...
						case PLAY_TYPE_OPEAR: 	strcpy(ptype,"戏剧");  break;
						case PLAY_TYPE_DRAMA: strcpy(ptype,"舞台剧"); 	break;
	}
   	system("clear");
   	printf("\n\n\n\n");
	...
	printf("\t\t\t╔================================================================================╗\n");
   	...
   	printf("\t\t\t‖%30s %20s %30s ‖\n"," ","X X 电影院"," ");
   	printf("\t\t\t‖"); printf("%80s‖\n"," ");
	printf("\t\t\t‖ \t%5s\t%-20s\t %5s\t%3d %3s %3d %3s","影厅：", std.ROOM ,"座位：", sed.row ,"排", sed.column,"列");  printf("\t\t\t\t ‖\n");
	printf("\t\t\t‖"); printf("%80s‖\n"," ");
